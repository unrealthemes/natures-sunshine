...
class WC_NovaPoshta_Shipping_Method_Poshtomat extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'nova_poshta_shipping_method_poshtomat'; 
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __('Delivery by "Nova Poshta Poshtomat', 'natures-sunshine');
	...
	public function init() {
		...
		$this->instance_form_fields = include ABSPATH . '/wp-content/plugins/woocommerce/includes/shipping/flat-rate/includes/settings-flat-rate.php';
