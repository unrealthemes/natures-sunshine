...
class WC_UT_Free_Shipping_Method extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'ut_free_shipping';
		$this->instance_id        = absint( $instance_id );
		$this->method_title       = __('Delivery by "Free Shipping', 'natures-sunshine');
		$this->method_description = 'Дозволяє вам встановити фіксовану ставку на доставку.';
		$this->enabled = 'yes';
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		...
		$settings = array(
			...
			'min_sum' => array(
				'title' => __('Мінімальна сума для безкоштовної доставки', 'natures-sunshine'),
				'type' => 'text',
				'placeholder' => 'Вкажіть суму цифрами',
				'description' => __('Введіть суму, при досягненні якої, доставка для покупця буде безкоштовною', 'natures-sunshine'),
			),
		);
	...
	public function calculate_shipping( $package = array() ) {
		...
		$min_sum   = $this->get_option( 'min_sum' );
