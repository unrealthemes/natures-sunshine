...
class BreadcrumbsClass
{
    ...
    public function trail()
    {
        ...
        if (0 < $item_count) {
            ...
            $breadcrumb .= sprintf(
                '<%s class="trail-items %s" itemscope itemtype="http://schema.org/BreadcrumbList">',
                tag_escape($this->args['list_tag']),
                $this->args['list_class']
            );
            ...
            foreach ($this->items as $item) {
                ...
                $item_class = 'trail-item ' . $this->args['item_class'];
                ...
                $separator = $item_count != $item_position ? $this->args['separator'] : '';
            ...
            $breadcrumb = sprintf(
                '<%1$s role="navigation" aria-label="%2$s" class="%3$s" itemprop="breadcrumb">%4$s%5$s%6$s</%1$s>',
